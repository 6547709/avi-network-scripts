...
values = {"attachments":[{"color":"#008000","text":"此事件代表“虚拟服务“恢复正常。","title":event_description,"fields":[{"short":"false","title":"对象名称","value":obj_name},{"short":"false","title":"事件ID","value":event_id},{"short":"false","title":"10分钟内发生次数","value":threshold}]}]}
